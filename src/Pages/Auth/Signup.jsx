            ...
            <section className="text-gray-600 body-font">
                ...
                <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                        <h2 className="mb-5 text-xl font-medium text-gray-900 title-font">
                            Signup
                        </h2>
                        ...
                        <button type="submit" className="w-full px-6 py-2 mt-4 text-white bg-yellow-500 rounded-lg hover:bg-yellow-600 focus:shadow-outline focus:outline-none">
                            Create Account
                        </button>
